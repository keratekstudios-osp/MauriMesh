...
echo ""
echo "============================================================"
echo "INSTALL MAURIMESH MASTER READINESS CHECKER"
echo "Verifies all completed layers together before APK build."
echo "============================================================"
echo ""
...
DOCS="$ROOT/docs"
BACKUP="$ROOT/backup-before-master-readiness-checker-$STAMP"
...
if [ -f "$ROOT/check-maurimesh-master-readiness.sh" ]; then
  cp "$ROOT/check-maurimesh-master-readiness.sh" "$BACKUP/check-maurimesh-master-readiness.sh"
fi

cat > "$ROOT/check-maurimesh-master-readiness.sh" <<'CHECK'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x "$ROOT/check-maurimesh-master-readiness.sh"
...
echo ""
echo "============================================================"
echo "DONE: MASTER READINESS CHECKER INSTALLED"
echo "============================================================"
echo "Created:"
