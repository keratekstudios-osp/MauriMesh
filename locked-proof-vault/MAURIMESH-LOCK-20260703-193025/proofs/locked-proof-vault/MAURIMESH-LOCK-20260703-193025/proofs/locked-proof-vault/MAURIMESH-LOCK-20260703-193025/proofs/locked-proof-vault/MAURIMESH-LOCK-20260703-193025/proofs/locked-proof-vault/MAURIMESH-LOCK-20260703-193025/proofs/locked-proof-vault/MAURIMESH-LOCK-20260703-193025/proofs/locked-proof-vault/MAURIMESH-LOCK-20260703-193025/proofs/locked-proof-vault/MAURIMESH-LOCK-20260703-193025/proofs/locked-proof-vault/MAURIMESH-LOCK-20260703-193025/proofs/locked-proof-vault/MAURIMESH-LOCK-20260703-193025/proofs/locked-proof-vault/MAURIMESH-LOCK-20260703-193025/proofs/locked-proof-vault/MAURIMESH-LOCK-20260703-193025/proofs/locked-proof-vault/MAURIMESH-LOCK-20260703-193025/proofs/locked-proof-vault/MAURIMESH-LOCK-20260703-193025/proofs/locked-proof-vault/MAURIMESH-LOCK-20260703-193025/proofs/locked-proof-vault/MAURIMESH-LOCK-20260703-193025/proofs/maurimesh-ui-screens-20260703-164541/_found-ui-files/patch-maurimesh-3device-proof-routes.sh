...
echo "============================================================"
echo "PATCH MAURIMESH 3-DEVICE PROOF ROUTES"
echo "Adds missing APK routes:"
echo "  app/3-device-proof.tsx"
echo "  app/ble-3-device-proof.tsx"
echo "No native BLE claim. Manual APK proof-screen logging only."
echo "============================================================"

ROOT="$(pwd)"
STAMP="$(date +%Y%m%d-%H%M%S)"
BACKUP="$ROOT/backup-before-3device-proof-routes-$STAMP"
...
mkdir -p "$BACKUP" "$ROOT/app"

for f in app/3-device-proof.tsx app/ble-3-device-proof.tsx app/dashboard.tsx; do
  if [ -f "$ROOT/$f" ]; then
...
cat > "$ROOT/app/3-device-proof.tsx" <<'TSX'
...
cat > "$ROOT/app/ble-3-device-proof.tsx" <<'TSX'
export { default } from "./3-device-proof";
TSX

echo ""
echo "============================================================"
echo "VERIFY ROUTE FILES"
echo "============================================================"
ls -lah "$ROOT/app/3-device-proof.tsx" "$ROOT/app/ble-3-device-proof.tsx"

echo ""
echo "============================================================"
echo "RUN TYPECHECK / EXPORT CHECK"
echo "============================================================"
...
echo "Routes added:"
echo "  /3-device-proof"
echo "  /ble-3-device-proof"
echo ""
echo "Next:"
echo "  Build new APK."
echo "  Install on A06/S10/A16."
echo "  Then rerun 3-device monitor."
echo "============================================================"
