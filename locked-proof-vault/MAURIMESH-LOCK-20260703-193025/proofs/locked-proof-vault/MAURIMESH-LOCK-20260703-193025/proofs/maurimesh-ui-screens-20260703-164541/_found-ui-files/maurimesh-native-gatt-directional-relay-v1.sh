...
SCREEN="app/native-gatt-directional-relay-proof.tsx"
DASH="app/dashboard.tsx"

echo "============================================================"
echo "MAURIMESH NATIVE GATT DIRECTIONAL RELAY PROOF v1"
echo "============================================================"

[ -f "$DASH" ] && cp "$DASH" "$ARCHIVE_DIR/dashboard.before-directional-relay-v1-${STAMP}.bak"
...
echo "[1] Optional dashboard route marker check..."
grep -q "native-gatt-directional-relay-proof" "$DASH" || true

echo "[2] TypeScript gate..."
npx tsc --noEmit

echo "[3] Expo export gate..."
npx expo export --platform android

REPORT="$DOC_DIR/NATIVE_GATT_DIRECTIONAL_RELAY_PROOF_V1_${STAMP}.md"
cat > "$REPORT" <<EOF2
...
cp "$REPORT" "$DOC_DIR/NATIVE_GATT_DIRECTIONAL_RELAY_PROOF_V1_LATEST.md"

echo "============================================================"
echo "FINAL VERDICT: READY_FOR_EAS_BUILD_DIRECTIONAL_RELAY_V1"
echo "Report: $REPORT"
echo "============================================================"
