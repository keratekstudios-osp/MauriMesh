...
- [x] Route file exists: app/hybrid-wifi-ble-mesh.tsx
- [x] Dashboard route wired: /hybrid-wifi-ble-mesh
- [x] Backup route registry contains: /hybrid-wifi-ble-mesh
- [x] Route file exists: app/message-fallback.tsx
- [x] Dashboard route wired: /message-fallback
- [x] Backup route registry contains: /message-fallback
- [x] Route file exists: app/pixel-calling-backup.tsx
- [x] Dashboard route wired: /pixel-calling-backup
- [x] Backup route registry contains: /pixel-calling-backup
...
- [x] Layer file exists: src/maurimesh/hybrid-wifi-ble-mesh/HybridWifiBleMeshTypes.ts
...
- [x] Marker found: createHybridFallbackOrder in src/maurimesh/hybrid-wifi-ble-mesh/BackupHybridWifiBleMeshEngine.ts
- [x] Marker found: createRetryPlan in src/maurimesh/message-fallback/MessageFallbackQueue.ts
- [x] Marker found: createPixelCallingFallbackBackupOrder in src/maurimesh/pixel-calling/PixelCallingBackupFallback.ts
...
- [x] Truth boundary found in src/maurimesh/hybrid-wifi-ble-mesh/BackupHybridWifiBleMeshEngine.ts
- [x] Truth boundary found in src/maurimesh/message-fallback/MessageAckFallbackEngine.ts
- [x] Truth boundary found in src/maurimesh/pixel-calling/PixelCallingBackupFallback.ts
...
- [!] PARTIAL: Pixel Calling missing clear truth label
...
- Score: 99%
- TypeScript: passed
- Final UI status: **AVAILABLE_WITH_PARTIALS**

⚠️ UI is available, but some routes/components/truth labels are partial.
...
Reports:
  /home/runner/workspace/docs/ui-available-complete-checklist-20260610-083818.md
  /home/runner/workspace/docs/ui-available-complete-checklist-latest.md
  /home/runner/workspace/docs/ui-available-complete-checklist-20260610-083818.json
...
# MauriMesh Hybrid Wi-Fi BLE Mesh Report

Generated: 20260610-083828

## Files
- [x] src/maurimesh/hybrid-wifi-ble-mesh/HybridWifiBleMeshTypes.ts exists
- [x] src/maurimesh/hybrid-wifi-ble-mesh/BackupHybridWifiBleMeshEngine.ts exists
- [x] src/maurimesh/hybrid-wifi-ble-mesh/index.ts exists
- [x] src/components/HybridWifiBleMeshPanel.tsx exists
- [x] app/hybrid-wifi-ble-mesh.tsx exists

## Transport Capabilities
- [x] Capability found: BLE_DIRECT
- [x] Capability found: BLE_RELAY
- [x] Capability found: STORE_FORWARD
- [x] Capability found: WIFI_LOCAL
- [x] Capability found: WIFI_DIRECT_READY
- [x] Capability found: INTERNET_GATEWAY
- [x] Capability found: OFFLINE_HOLD
- [x] Capability found: createHybridFallbackOrder
- [x] Capability found: decideBackupHybridWifiBleRoute
- [x] Capability found: HYBRID_ROUTE_DECISION
- [x] Capability found: HYBRID_FAILOVER
- [x] Capability found: HYBRID_STORE_FORWARD
- [x] Capability found: HYBRID_GATEWAY_READY

## Route Wiring
- [x] Dashboard has /hybrid-wifi-ble-mesh
- [x] Backup registry has /hybrid-wifi-ble-mesh
- [x] Screen uses HybridWifiBleMeshPanel

## Embedded Wiring
- [x] MauriCore BLE Runtime includes HybridWifiBleMeshPanel
- [x] BLE Hardware Runtime includes HybridWifiBleMeshPanel
- [x] Device Proof includes HybridWifiBleMeshPanel
...
============================================================
HYBRID WIFI BLE MESH CHECK COMPLETE
Status: COMPLETE
Score:  100%
Report: /home/runner/workspace/docs/maurimesh-hybrid-wifi-ble-mesh-report-latest.md
============================================================

- [x] Hybrid Wi-Fi BLE Mesh checker passed

### Message Queue + ACK Fallback
...
============================================================
MESSAGE QUEUE + ACK FALLBACK CHECK COMPLETE
Status: COMPLETE
Score:  100%
Report: /home/runner/workspace/docs/maurimesh-message-ack-fallback-report-latest.md
============================================================

- [x] Message Queue + ACK Fallback checker passed

### Pixel Calling Backup Fallback

# MauriMesh Pixel Calling Backup Fallback Report

Generated: 20260610-083830

## Files
- [x] src/maurimesh/pixel-calling/PixelCallingBackupTypes.ts exists
- [x] src/maurimesh/pixel-calling/PixelCallingBackupFallback.ts exists
- [x] src/components/PixelCallingBackupFallbackPanel.tsx exists
- [x] app/pixel-calling-backup.tsx exists

## Backup Fallback Capabilities
- [x] Capability found: PRIMARY_CALL_RUNTIME
- [x] Capability found: BACKUP_CALL_CONTROL
- [x] Capability found: PUSH_TO_TALK_BACKUP
- [x] Capability found: VOICE_NOTE_BACKUP
- [x] Capability found: TEXT_MESSAGE_BACKUP
- [x] Capability found: STORE_FORWARD_BACKUP
- [x] Capability found: SAFE_CALL_HOLD
- [x] Capability found: PRIMARY_RUNTIME_FAILED
- [x] Capability found: NO_STRICT_ACK
- [x] Capability found: NO_AUDIO_PERMISSION
- [x] Capability found: HARDWARE_PRESSURE
- [x] Capability found: NO_LIVE_TRANSPORT
- [x] Capability found: createPixelCallingFallbackBackupOrder
- [x] Capability found: decidePixelCallingBackupFallback
- [x] Capability found: runPixelCallingBackupFallbackDemo

## Route + Backup Wiring
- [x] Dashboard has /pixel-calling-backup
- [x] Backup registry has /pixel-calling-backup
- [x] Backup screen uses PixelCallingBackupFallbackPanel
- [x] Pixel Calling screen embeds backup fallback panel

## Embedded Proof Wiring
- [x] Device Proof includes PixelCallingBackupFallbackPanel
- [x] Proof Ledger includes PixelCallingBackupFallbackPanel
- [x] Message Fallback includes PixelCallingBackupFallbackPanel

## Truth Protection
- [x] Pixel Calling backup truth boundary present
...
============================================================
PIXEL CALLING BACKUP FALLBACK CHECK COMPLETE
Status: COMPLETE
Score:  100%
Report: /home/runner/workspace/docs/maurimesh-pixel-calling-backup-fallback-report-latest.md
============================================================

- [x] Pixel Calling Backup Fallback checker passed
...
============================================================
AI PIXEL RECONSTRUCTION CHECK COMPLETE
Status: COMPLETE_WITH_WARNINGS
Score:  97%
Report: /home/runner/workspace/docs/maurimesh-ai-pixel-reconstruction-report-latest.md
============================================================

- [x] AI Pixel Reconstruction checker passed
