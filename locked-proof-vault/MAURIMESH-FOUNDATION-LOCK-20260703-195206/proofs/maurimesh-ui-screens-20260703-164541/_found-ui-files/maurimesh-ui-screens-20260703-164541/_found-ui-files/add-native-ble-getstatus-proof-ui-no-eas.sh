...
echo "=================================================="
echo "ADD NATIVE BLE getStatus() PROOF UI — NO LIVE BLE"
echo "=================================================="

BACKUP="$HOME/maurimesh-router-backups/backup-before-native-ble-getstatus-proof-$(date +%Y%m%d-%H%M%S)"
mkdir -p "$BACKUP"
cp app/native-ble-status.tsx "$BACKUP/native-ble-status.tsx" 2>/dev/null || true
...
echo ""
echo "1. Confirm marker"
grep -Rni "NATIVE_BLE_GETSTATUS_PROOF_20260607_A" app/native-ble-status.tsx

echo ""
echo "2. Confirm NativeModules call"
grep -RniE "NativeModules\\.MauriMeshBle|getStatus" app/native-ble-status.tsx
...
echo ""
echo "=================================================="
echo "NATIVE BLE getStatus() PROOF UI READY — NO EAS USED"
echo "Next APK expected marker: NATIVE_BLE_GETSTATUS_PROOF_20260607_A"
echo "=================================================="
