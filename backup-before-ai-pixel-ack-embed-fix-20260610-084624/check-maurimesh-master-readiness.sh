...
TRUTH_MARKERS=(
  ...
  "src/maurimesh/pixel-calling/PixelCallingBackupFallback.ts:does not claim a live call without installed APK audio proof and strict device ACK"
)
...
# master marker file   "src/maurimesh/pixel-calling/PixelCallingBackupTypes.ts"

# master marker file   "src/maurimesh/pixel-calling/PixelCallingBackupFallback.ts"

# master marker file   "src/components/PixelCallingBackupFallbackPanel.tsx"

# master marker   "src/maurimesh/pixel-calling/PixelCallingBackupFallback.ts:decidePixelCallingBackupFallback"

# master marker   "src/maurimesh/pixel-calling/PixelCallingBackupTypes.ts:PUSH_TO_TALK_BACKUP"

# master marker   "src/maurimesh/pixel-calling/PixelCallingBackupTypes.ts:VOICE_NOTE_BACKUP"

# master marker   "src/maurimesh/pixel-calling/PixelCallingBackupTypes.ts:STORE_FORWARD_BACKUP"

# master route marker /ai-pixel-reconstruction

# master marker file   "src/maurimesh/pixel-calling/AiPixelReconstructionTypes.ts"

# master marker file   "src/maurimesh/pixel-calling/AiPixelReconstructionEngine.ts"

# master marker file   "src/components/AiPixelReconstructionPanel.tsx"

# master marker   "src/maurimesh/pixel-calling/AiPixelReconstructionEngine.ts:decideAiPixelReconstruction"

# master marker   "src/maurimesh/pixel-calling/AiPixelReconstructionEngine.ts:AI_PIXEL_RECONSTRUCTION_TARGETS"

# master marker   "src/maurimesh/pixel-calling/AiPixelReconstructionEngine.ts:calculateReconstructedPixelMultiplier"

# master marker   "src/maurimesh/pixel-calling/AiPixelReconstructionTypes.ts:SOURCE_1080P_CAPTURED"

# master marker   "src/maurimesh/pixel-calling/AiPixelReconstructionTypes.ts:AI_UPSCALE_TARGET_32K"

# master marker   "src/maurimesh/pixel-calling/AiPixelReconstructionTypes.ts:RECONSTRUCTED_PIXEL_ACK_RECEIVED"

# master truth   "src/maurimesh/pixel-calling/AiPixelReconstructionEngine.ts:does not claim raw 32K live streaming"
