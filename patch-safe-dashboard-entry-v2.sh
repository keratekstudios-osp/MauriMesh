...
echo ""
echo "============================================================"
echo "MAURIMESH SAFE DASHBOARD ENTRY v2"
echo "============================================================"
echo "Goal:"
echo "- Stop Open Dashboard crash"
echo "- Replace dashboard with dependency-light safe route"
echo "- Use only React Native primitives + expo-router"
echo "- Preserve proof route buttons"
echo "- Do not claim native BLE/GATT PASS"
echo "============================================================"

ROOT="$(pwd)"
STAMP="$(date +%Y%m%d-%H%M%S)"
BACKUP="$ROOT/backup-before-safe-dashboard-entry-v2-$STAMP"
REPORT="$ROOT/docs/runtime-crash/safe-dashboard-entry-v2-$STAMP.md"
...
if [ -f "$TARGET" ]; then
  ...
  echo "Backed up existing dashboard:"
  echo "$BACKUP/app/dashboard.tsx"
fi
...
echo ""
echo "============================================================"
echo "VERIFY SAFE DASHBOARD"
echo "============================================================"

grep -n "Safe Dashboard\|MAURIMESH_SAFE_DASHBOARD_OPEN\|locked-proof-vault\|proof-vault-health\|learner-core" "$TARGET"
...
echo ""
echo "============================================================"
echo "SAFE DASHBOARD ENTRY v2 COMPLETE"
echo "============================================================"
echo "Backup: $BACKUP"
echo "Report: $REPORT"
echo ""
echo "IMPORTANT:"
echo "- The APK already building will not include this if upload already started."
echo "- The next APK build must include this patch."
echo "============================================================"
